const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2025-05-21', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://xy5206.com' },
    { title: '欲买桂花同载酒，终不似，少年游', url: 'https://xy5206.com' }
  ],
  ...
  HEO_HERO_CATEGORY_3: { title: '好书推荐', url: '/tag/好书推荐' },
