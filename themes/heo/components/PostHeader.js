      ...
      <style jsx>{`
        .coverdiv:after {
          ...
          box-shadow: 110px -130px 500px 100px
            ${isDarkMode ? '#CA8A04' : '#BAD7DF'} inset;
        }
      `}</style>

      <div
        className={`${isDarkMode ? 'bg-[#CA8A04]' : 'bg-[#BAD7DF]'} absolute top-0 w-full h-full py-10 flex justify-center items-center`}>
        {/* 文章背景图 */}
        <div
          ...
          className='coverdiv opacity-60 lg:opacity-50 translate-x-20 lg:translate-x-96 lg:rotate-12'>
          <LazyImage
            id='post-cover'
